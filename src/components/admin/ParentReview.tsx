...
import { reviewParent, type ParentApplyState } from "@/lib/parent/actions";

const initial: ParentApplyState = {};

export function ParentReview({ userId }: { userId: string }) {
  const [state, action, pending] = useActionState(reviewParent, initial);
  return (
